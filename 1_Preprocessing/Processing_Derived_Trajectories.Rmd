...
UnRarefy <- readRDS(paste0(path, "Data/Preprocessing/final_datasets/02_UnRarefied_Merged_Milk_Nasal_Gut.rds"))
...
saveRDS(data_NG2, file = paste0(path, "Data/Data_subsets/Main_UnRarefied_NasalGut_Subset.rds"))
```
...
saveRDS(Main_data_2, file = paste0(path, "Data/Data_subsets/Main_Rarefied_NasalGut_Subset.rds"))
```
...
saveRDS(Nasal_3M1Y_pa_filt, file = paste0(path, "Data/Data_subsets/Main_Nasal_Trajectory_Subset.rds"))
```
...
saveRDS(Gut_3M1Y_pa_filt, file = paste0(path, "Data/Data_subsets/Main_Gut_Trajectory_Subset.rds"))
```
...
### write.csv(N_PerTaxa_coloniz, file="Data/Data_subsets/Nasal_perTaxa_PctColonizeInfant.csv")
```
...
### write.csv(G_PerTaxa_coloniz, file="Data/Data_subsets/Gut_perTaxa_PctColonizeInfant.csv")
```
...
CHILD_metadata_all <- readRDS(paste0(path, "Data/Preprocessing/metadata_input/3FINAL_Full_Cleaned_KF_Modified_Updated-05222021_withSprio"))
...
saveRDS(CHILD_metadata_all3, file=paste0(path, "Data/Preprocessing/metadata_input/4FINAL_Full_Cleaned_KF_Modified_V2_withRE_forSubj_withNG.rds")) ## all CHILD participants, save edited version
```
...
saveRDS(Traj_data_ls, file=paste0(path, "Data/Data_subsets/ALL_Trajectory_Derived_Data.rds"))
```
